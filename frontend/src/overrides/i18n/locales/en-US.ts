...
export default {
    ...
    canvas: {
        ...
        apiKeys: {
            ...
            bindingTitle: "Studio API key binding",
            bindingDescription: "Choose which Sub2API key Studio may use. The key is fetched server-side and stored encrypted; it is never returned to this browser.",
            bindingLoadFailed: "API keys could not be loaded",
            bind: "Bind",
            bound: "API key bound",
            boundStatus: "Bound",
            bindConfirmTitle: "Bind {{name}} to Studio?",
            bindConfirmDescription: "Generation requests will use this key's permissions, quota, and billing. The standalone Studio stores it with AES-256-GCM encryption.",
            unbind: "Unbind",
            unbound: "API key unbound",
            unbindConfirm: "Unbind this API key from Studio?",
            noOfficialKeys: "Your Sub2API account has no API keys",
            active: "Active",
